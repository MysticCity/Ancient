  ...
  extends ComplexItem
{
  ...
  {
    return new ElseItem(!this.b, this.w);
  }
  
  public ElseItem(boolean preview, de.pylamo.spellmaker.gui.Window w)
  {
    super(w);
    setLayout(null);
    this.b = (!preview);
    ...
    if (preview)
    {
      this.istp = new SimpleStartPanel("else");
      createDragSource();
    }
    else
    {
    ...
    implements DragGestureListener, DragSourceMotionListener
  {
    ...
    public void dragGestureRecognized(DragGestureEvent dge)
    {
      ...
      BufferedImage bi = new BufferedImage(ElseItem.this.getWidth(), ElseItem.this.getHeight(), 2);
      ElseItem.this.paint(bi.getGraphics());
      Cursor cursor = null;
...
/* Location:              C:\Users\Jens\Desktop\Spigot Server\plugins\Ancient_v1.1.0 (1).jar!\de\pylamo\spellmaker\gui\SpellItems\Condition\ElseItem.class
