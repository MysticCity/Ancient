...
public class AnimatedBall extends ICommand {
	@CommandDescription(description = "<html>Creates an animated ball at the given location</html>",
			argnames = {"location", "particlename", "particles", "particles per iteration", "size", "x rotation", "y rotation", "z rotation", "x factor", "y factor", "z factor", "period", "iterations"}, name = "AnimatedBall", parameters = {ParameterType.Location, ParameterType.String, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number})
	public AnimatedBall() {
