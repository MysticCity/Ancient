...
public class Donut extends ICommand {
	@CommandDescription(description = "<html>Creates a donut at the given location</html>",
			argnames = {"location", "particlename", "particles per circle", "circles", "radius donut", "radius tube", "x rotation", "y rotation", "z rotation", "period", "iterations"}, name = "Donut", parameters = {ParameterType.Location, ParameterType.String, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number})
	public Donut() {
