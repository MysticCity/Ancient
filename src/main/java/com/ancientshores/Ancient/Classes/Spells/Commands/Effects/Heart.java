...
public class Heart extends ICommand {
	@CommandDescription(description = "<html>Creates a heart at the given location</html>",
			argnames = {"location", "particlename", "particles", "x rotation", "y rotation", "z rotation", "x factor", "y factor", "factor of inner spike (the \\/)", "compress factor along y axis", "compilation"}, name = "Heart", parameters = {ParameterType.Location, ParameterType.String, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number})
	public Heart() {
