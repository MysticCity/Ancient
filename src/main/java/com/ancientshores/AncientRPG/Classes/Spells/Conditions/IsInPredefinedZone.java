...
public class IsInPredefinedZone extends IArgument {
    @ArgumentDescription(
            description = "Returns true if the given location is in the defined bounds of the zone",
            parameterdescription = {"location", "world", "x1", "y1", "z1", "x2", "y2", "z2"}, returntype = ParameterType.Number, rparams = {ParameterType.Location, ParameterType.String, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number})
