...
public enum Arguments {
    ...
    GetPlayerByUUID("Finds an online player on the server with the specified uuid", new String[]{"uuid"}, "GetPlayerByUUID", new ParameterType[]{ParameterType.UUID}, ParameterType.Player),
    ...
    IsLookingAt("Returns true if the entity is looking at the other entity within the specific range", new String[]{"entity", "entity2", "range"}, "IsLookingAt", new ParameterType[]{ParameterType.Entity, ParameterType.Entity, ParameterType.Number}, ParameterType.Boolean),
    ...
    PlayerExists("Returns true if the player with the specified name is online on the server, false otherwise", new String[]{"playername"}, "PlayerExists", new ParameterType[]{ParameterType.String}, ParameterType.Boolean),
