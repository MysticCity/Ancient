...
public enum Commands {
    ...
    AddItem("<html>Adds the specified amount of items to the invenory of the player</html>", new String[]{"the player", "the itemid", "the amount"}, "AddItem", new ParameterType[]{ParameterType.Player, ParameterType.Material, ParameterType.Number}),
