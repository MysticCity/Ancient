...
//			if (Variable.playerVars.get(p.getUniqueId()).containsKey(varName)) throw new AncientVariableAlreadyExistsException(this.spell.getName(), this.getClass().getName(), this.line, varName);
