...
public class AncientPermission implements ConfigurationSerializable {
	...
	public AncientPermission(Map<String, Object> map) {
		...
		this.children = (List<AncientPermission>) map.get("children");
	}
	...
	public Map<String, Boolean> getChildrenAsMap() {
		...
		for (AncientPermission perm : children) {
