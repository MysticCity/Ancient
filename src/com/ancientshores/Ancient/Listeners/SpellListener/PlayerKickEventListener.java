...
public class PlayerKickEventListener
  extends ISpellListener
{
  public PlayerKickEventListener(Ancient instance)
  {
    super(instance);
    this.eventName = "playerkickevent";
...
/* Location:              C:\Users\Jens\Desktop\Spigot Server\plugins\Ancient_v1.1.0 (1).jar!\com\ancientshores\Ancient\Listeners\SpellListener\PlayerKickEventListener.class
