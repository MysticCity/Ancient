  ...
  extends ICommand
{
  ...
  {
    if ((ca.getParams().size() == 8) && ((ca.getParams().get(7) instanceof Number)) && ((ca.getParams().get(6) instanceof Number)) && ((ca.getParams().get(5) instanceof Number)) && ((ca.getParams().get(4) instanceof Number)) && ((ca.getParams().get(3) instanceof Boolean)) && ((ca.getParams().get(2) instanceof String)) && ((ca.getParams().get(1) instanceof Location[])) && ((ca.getParams().get(0) instanceof Location[])))
    {
      ...
      boolean isZigZag = ((Boolean)ca.getParams().get(3)).booleanValue();
...
/* Location:              C:\Users\Jens\Desktop\Spigot Server\plugins\Ancient_v1.1.0 (1).jar!\com\ancientshores\Ancient\Classes\Spells\Commands\Effects\Line.class
