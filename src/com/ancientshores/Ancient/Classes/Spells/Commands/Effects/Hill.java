...
public class Hill
  extends ICommand
{
  @CommandDescription(description="<html>Creates a hill at the given location</html>", argnames={"location", "particlename", "height", "particles per row", "y rotation", "period", "iterations"}, name="Hill", parameters={ParameterType.Location, ParameterType.String, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number})
  public Hill()
  {
...
/* Location:              C:\Users\Jens\Desktop\Spigot Server\plugins\Ancient_v1.1.0 (1).jar!\com\ancientshores\Ancient\Classes\Spells\Commands\Effects\Hill.class
