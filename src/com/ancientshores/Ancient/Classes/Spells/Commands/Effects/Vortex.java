...
public class Vortex
  extends ICommand
{
  @CommandDescription(description="<html>Creates a vortex at the given location</html>", argnames={"location", "particlename", "radius", "grow per iteration", "radials per iteration", "helix circles per iterations", "helices", "period", "iterations"}, name="Vortex", parameters={ParameterType.Location, ParameterType.String, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number})
  public Vortex()
  {
...
/* Location:              C:\Users\Jens\Desktop\Spigot Server\plugins\Ancient_v1.1.0 (1).jar!\com\ancientshores\Ancient\Classes\Spells\Commands\Effects\Vortex.class
