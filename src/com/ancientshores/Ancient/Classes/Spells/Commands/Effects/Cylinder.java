  ...
  extends ICommand
{
  ...
  {
    if ((ca.getParams().size() == 15) && ((ca.getParams().get(14) instanceof Number)) && ((ca.getParams().get(13) instanceof Number)) && ((ca.getParams().get(12) instanceof Number)) && ((ca.getParams().get(11) instanceof Number)) && ((ca.getParams().get(10) instanceof Number)) && ((ca.getParams().get(9) instanceof Boolean)) && ((ca.getParams().get(8) instanceof Boolean)) && ((ca.getParams().get(7) instanceof Number)) && ((ca.getParams().get(6) instanceof Number)) && ((ca.getParams().get(5) instanceof Number)) && ((ca.getParams().get(4) instanceof Number)) && ((ca.getParams().get(3) instanceof Number)) && ((ca.getParams().get(2) instanceof Number)) && ((ca.getParams().get(1) instanceof String)) && ((ca.getParams().get(0) instanceof Location[])))
    {
      ...
      boolean solid = ((Boolean)ca.getParams().get(8)).booleanValue();
      
      boolean enableRotation = ((Boolean)ca.getParams().get(9)).booleanValue();
...
/* Location:              C:\Users\Jens\Desktop\Spigot Server\plugins\Ancient_v1.1.0 (1).jar!\com\ancientshores\Ancient\Classes\Spells\Commands\Effects\Cylinder.class
