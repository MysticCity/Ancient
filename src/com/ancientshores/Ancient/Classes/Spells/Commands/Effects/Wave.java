...
public class Wave
  extends ICommand
{
  @CommandDescription(description="<html>Creates a wave at the given location</html>", argnames={"location", "wave particlename", "cloud particlename", "speed x", "speed y", "speed z", "particles on the front forming the tube", "particles forming the back", "width of wave in rows", "length of front", "length of back", "depth of parabola tube", "height of parabola arc at the end", "height", "width", "period", "iterations"}, name="Wave", parameters={ParameterType.Location, ParameterType.String, ParameterType.String, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number})
  public Wave()
  {
  ...
  {
    if ((ca.getParams().size() == 17) && ((ca.getParams().get(16) instanceof Number)) && ((ca.getParams().get(15) instanceof Number)) && ((ca.getParams().get(14) instanceof Number)) && ((ca.getParams().get(13) instanceof Number)) && ((ca.getParams().get(12) instanceof Number)) && ((ca.getParams().get(11) instanceof Number)) && ((ca.getParams().get(10) instanceof Number)) && ((ca.getParams().get(9) instanceof Number)) && ((ca.getParams().get(8) instanceof Number)) && ((ca.getParams().get(7) instanceof Number)) && ((ca.getParams().get(6) instanceof Number)) && ((ca.getParams().get(5) instanceof Number)) && ((ca.getParams().get(4) instanceof Number)) && ((ca.getParams().get(3) instanceof Number)) && ((ca.getParams().get(2) instanceof String)) && ((ca.getParams().get(1) instanceof String)) && ((ca.getParams().get(0) instanceof Location[])))
    {
...
/* Location:              C:\Users\Jens\Desktop\Spigot Server\plugins\Ancient_v1.1.0 (1).jar!\com\ancientshores\Ancient\Classes\Spells\Commands\Effects\Wave.class
