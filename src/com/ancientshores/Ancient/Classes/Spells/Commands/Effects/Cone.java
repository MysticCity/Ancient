...
public class Cone extends ICommand {
	...
	public boolean playCommand(final EffectArgs ca) {
		if (ca.getParams().size() == 11
			...
			boolean randomize = (Boolean) ca.getParams().get(8);
