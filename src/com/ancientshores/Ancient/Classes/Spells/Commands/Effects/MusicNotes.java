...
public class MusicNotes extends ICommand {
	@CommandDescription(description = "<html>Spawns music notes at the given location</html>",
			argnames = {"location", "radials per step", "radius", "period", "iterations"}, name = "MusicNotes", parameters = {ParameterType.Location, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number})
	public MusicNotes() {
