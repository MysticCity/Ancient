...
public class BigBang
  extends ICommand
{
  @CommandDescription(description="<html>Creates a big firework explosion at the given location</html>", argnames={"location", "firework type", "color 1 red", "color 1 green", "color 1 blue", "color 2 red", "color 2 green", "color 2 blue", "color 3 red", "color 3 green", "color 3 blue", "fade color red", "fade color green", "fade color blue", "intensity", "radius", "explosions", "sound interval", "sound", "sound volume", "sound pitch", "period", "iterations"}, name="BigBang", parameters={ParameterType.Location, ParameterType.String, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.String, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number})
  public BigBang()
  {
  ...
  {
    if ((ca.getParams().size() == 23) && ((ca.getParams().get(22) instanceof Number)) && ((ca.getParams().get(21) instanceof Number)) && ((ca.getParams().get(20) instanceof Number)) && ((ca.getParams().get(19) instanceof Number)) && ((ca.getParams().get(18) instanceof String)) && ((ca.getParams().get(17) instanceof Number)) && ((ca.getParams().get(16) instanceof Number)) && ((ca.getParams().get(15) instanceof Number)) && ((ca.getParams().get(14) instanceof Number)) && ((ca.getParams().get(13) instanceof Number)) && ((ca.getParams().get(12) instanceof Number)) && ((ca.getParams().get(11) instanceof Number)) && ((ca.getParams().get(10) instanceof Number)) && ((ca.getParams().get(9) instanceof Number)) && ((ca.getParams().get(8) instanceof Number)) && ((ca.getParams().get(7) instanceof Number)) && ((ca.getParams().get(6) instanceof Number)) && ((ca.getParams().get(5) instanceof Number)) && ((ca.getParams().get(4) instanceof Number)) && ((ca.getParams().get(3) instanceof Number)) && ((ca.getParams().get(2) instanceof Number)) && ((ca.getParams().get(1) instanceof String)) && ((ca.getParams().get(0) instanceof Location[])))
    {
...
/* Location:              C:\Users\Jens\Desktop\Spigot Server\plugins\Ancient_v1.1.0 (1).jar!\com\ancientshores\Ancient\Classes\Spells\Commands\Effects\BigBang.class
