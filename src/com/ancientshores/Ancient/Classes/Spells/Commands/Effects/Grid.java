...
public class Grid
  extends ICommand
{
  @CommandDescription(description="<html>Creates a grid at the given location</html>", argnames={"location", "particlename", "rows", "columns", "width of cell", "height of cell", "particles spawned along horizontal borders of cell", "particles spawned along vertical borders of cell", "rotation", "period", "iterations"}, name="Grid", parameters={ParameterType.Location, ParameterType.String, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number, ParameterType.Number})
  public Grid()
  {
...
/* Location:              C:\Users\Jens\Desktop\Spigot Server\plugins\Ancient_v1.1.0 (1).jar!\com\ancientshores\Ancient\Classes\Spells\Commands\Effects\Grid.class
