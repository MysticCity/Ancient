...
public class Smoke extends ICommand {
	@CommandDescription(description = "<html>Creates smoke at the given location</html>",
			argnames = {"location", "particlename", "period", "iterations"}, name = "SmokeEffect", parameters = {ParameterType.Location, ParameterType.String, ParameterType.Number, ParameterType.Number})
	public Smoke() {
