...
public class PotionEffectCommand
  extends ICommand
{
  @CommandDescription(description="<html>Adds a potioneffect with the specified effect to the entity for the specified duration</html>", argnames={"entity", "name", "duration", "amplifier"}, name="PotionEffect", parameters={ParameterType.Entity, ParameterType.String, ParameterType.Number, ParameterType.Number})
...
/* Location:              C:\Users\Jens\Desktop\Spigot Server\plugins\Ancient_v1.1.0 (1).jar!\com\ancientshores\Ancient\Classes\Spells\Commands\PotionEffectCommand.class
