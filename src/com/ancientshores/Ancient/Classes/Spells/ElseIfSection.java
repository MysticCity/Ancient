...
public class ElseIfSection
  extends ICodeSection
{
  final ICodeSection parentSection;
  Condition c;
  
  public ElseIfSection(String curline, BufferedReader bf, int linenumber, Spell p, ICodeSection parent)
    throws IOException
  {
...
/* Location:              C:\Users\Jens\Desktop\Spigot Server\plugins\Ancient_v1.1.0 (1).jar!\com\ancientshores\Ancient\Classes\Spells\ElseIfSection.class
